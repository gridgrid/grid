...
var gridAbsoluteDivs = require('grid-absolute-divs');
...
module.exports = function (container) {
    ...
    var precreatedTextNodes = true;
    var htmlOnlyText = false;
    var htmlAnchor = false;
    ...
    return Object.merge(grid, {
        ...
        setPrecreatedNodes: function (use) {
            precreatedTextNodes = use;
        },
        setHtmlOnlyText: function (only) {
            htmlOnlyText = only;
        },
        setHtmlAnchor: function (anchor) {
            htmlAnchor = anchor;
        }
    });
};
