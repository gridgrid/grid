...
describe("copy-paste", function () {
  ...
  beforeEach(function () {
    ...
    this.tableString =
      '<table><tbody><tr><td grid-data="[1,2]">r1 c2</td><td grid-data="[1,3]">r1 c3</td></tr><tr><td grid-data="[2,2]">r2 c2</td><td grid-data="[2,3]">r2 c3</td></tr></tbody></table>';
  });
  ...
  describe("copy", function () {
    ...
    it("should escape html in copied html", function () {
      ...
      expect(e.clipboardData.setData).toHaveBeenCalledWith(
        "text/plain",
        '"r<img src=""xx"" onerror=""alert(\'xss attack\')"" /> c2"\tr1 c3\nr2 c2\tr2 c3'
      );

      // NOTE: this was the old one
      // expect(e.clipboardData.setData).toHaveBeenCalledWith(
      //   "text/html",
      //   '<table><tbody><tr><td grid-data="[&quot;&lt;img src=\\&quot;xx\\&quot; onerror=\\&quot;alert(\'xss attack\')\\&quot; /&gt;&quot;,&quot;2&quot;]">r&lt;img src="xx" onerror="alert(\'xss attack\')" /&gt; c2</td><td grid-data="[1,3]">r1 c3</td></tr><tr><td grid-data="[2,2]">r2 c2</td><td grid-data="[2,3]">r2 c3</td></tr></tbody></table>'
      // );
    ...
    describe("text area selection", function () {
      beforeEach(function () {
        ...
        expect(this.grid.textarea.selectionStart).toEqual(
          this.grid.textarea.selectionEnd
        );
      });
              ...
              expect(args).toContain({
                ...
                value:
                  (Array.isArray(expectedData) &&
                    expectedData[r - range.top][c - range.left]) ||
                  undefined,
                formatted:
                  (typeof expectedData === "string" && expectedData) ||
                  "r" + r + " c" + c,
                paste: true,
              });
            }
